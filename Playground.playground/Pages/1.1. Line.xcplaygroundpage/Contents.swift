...
/*: Line
 # Line
 Continuous line defined by either the combination of a slope and y-intercept, or, if vertical, by the x-position.
 */

let slopedLine1 = Line(slope: 0.5, yIntercept: 2.0)

// Initialize a line through 2 points:
...
// Initialize a line following a LineSegment (a line between two points):
